    ...
    <div id={@id} class="flex pr-4">
      ...
      <div class="flex h-8 font-medium">
        <div
          ...
          :if={current_page > 0}
          class={[
            (current_page == @options.page && "border-orange-500") || "border-transparent",
            "w-8 md:flex justify-center items-center hidden cursor-pointer leading-5 transition duration-150 ease-in border-b-2"
          ]}
        >
